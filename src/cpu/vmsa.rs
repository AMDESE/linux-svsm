...
// VMGEXIT Parameter feature is enabled
/// Bit 10
pub const SEV_FEAT_VMGEXIT_PARAM: u64 = BIT!(10);

// Performance Counter virtualization feature
/// Bit 11
pub const SEV_FEAT_PMC_VIRT: u64 = BIT!(11);

// IBS virtualization feature is enabled
/// Bit 12
pub const SEV_FEAT_IBS_VIRT: u64 = BIT!(12);

// Guest intercept control is enabled
/// Bit 13
pub const SEV_FEAT_GUEST_INTERCEPT_CTRL: u64 = BIT!(13);
...
// Reserved
/// Bits [63:15]
pub const SEV_FEAT_RESERVED: u64 = !(BIT!(15) - 1);
...
//  8 - VMPLSSS                    DC              DC
//  9 - SecureTSC                  MBZ             DC
// 10 - VmgexitParameter           MBZ             DC
// 11 - PerfCtrVirt                DC              DC
// 12 - IbsVirt                    DC              DC
// 13 - GuestInterceptControl      MBZ             MBZ
