...
#define SVSM_CPL3_GVA_START		0x00100000
#define SVMS_CPL3_GVA_START_ASM	ASM_ULL(SVSM_CPL3_GVA_OFFSET)

#define SVSM_CPL3_GVA_ASM		SVMS_CPL3_GVA_START_ASM
#define SVSM_CPL3_GVA_LDS		SVSM_CPL3_GVA_START
...
#define SVSM_SNP_MEASURED_PAGES_BASE	(edata + CPL3_SIZE)
